class ToggleContactController extends Stimulus.Controller {
  toggleElement() {
    ...
    setTimeout(() => {
      ...
      var about = document.querySelector(".contact") 
...
application.register("contact-toggle", ToggleContactController)
